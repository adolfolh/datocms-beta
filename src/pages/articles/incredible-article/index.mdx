...
export const meta = {
  author: 'Adam Wathan',
  date: '2022-12-30',
  title: 'Lorem markdownum, bracchia in redibam! Terque unda puppi nec',
  description:
    'Deus feram verumque, fecit, ira tamen, terras per alienae victum. Mutantur levitate quas ubi arcum ripas oculos abest.',
}

export default (props) => <ArticleLayout meta={meta} {...props} />

Lorem markdownum, bracchia in redibam! Terque unda puppi nec, linguae posterior in utraque respicere candidus Mimasque formae; quae conantem cervice.
